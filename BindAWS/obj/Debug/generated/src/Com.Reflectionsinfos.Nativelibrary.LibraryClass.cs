...
#pragma warning restore 0169
		...
		static Delegate cb_openView_Landroid_content_Context_;
#pragma warning disable 0169
		static Delegate GetOpenView_Landroid_content_Context_Handler ()
		{
			if (cb_openView_Landroid_content_Context_ == null)
				cb_openView_Landroid_content_Context_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_OpenView_Landroid_content_Context_);
			return cb_openView_Landroid_content_Context_;
		}

		static void n_OpenView_Landroid_content_Context_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Reflectionsinfos.Nativelibrary.LibraryClass __this = global::Java.Lang.Object.GetObject<global::Com.Reflectionsinfos.Nativelibrary.LibraryClass> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Android.Content.Context p0 = global::Java.Lang.Object.GetObject<global::Android.Content.Context> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.OpenView (p0);
...
#pragma warning restore 0169
		...
		static IntPtr id_openView_Landroid_content_Context_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.reflectionsinfos.nativelibrary']/class[@name='LibraryClass']/method[@name='openView' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register ("openView", "(Landroid/content/Context;)V", "GetOpenView_Landroid_content_Context_Handler")]
		public virtual unsafe void OpenView (global::Android.Content.Context p0)
		{
			if (id_openView_Landroid_content_Context_ == IntPtr.Zero)
				id_openView_Landroid_content_Context_ = JNIEnv.GetMethodID (class_ref, "openView", "(Landroid/content/Context;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_openView_Landroid_content_Context_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "openView", "(Landroid/content/Context;)V"), __args);
			} finally {
			}
		}
